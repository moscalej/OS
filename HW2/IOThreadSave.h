...
typedef enum printMsg {newAccount, accountExists, doesntExist, badPassword, success_deposit, insufficient, success_withdraw, balance,close, success_transfer} printMsg;
class IOThreadSave {
public:
    ...
    void Bank_to_Log(float rate, int amount, int id);
